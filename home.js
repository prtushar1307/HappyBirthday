...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const birthdayDate = new Date('August 01, 2007 00:00:00').getTime();

    // CUSTOMIZE: Change this greeting message
    const greetingText = "Really sorry for the late wishess... 😭❤️ I'm just learning all these new things to surprise youuu but took me a little longer than i expected.... :) so the wishes got delayed... I'm really sorryyy I hope this little surprise makess youu.😁💖";
